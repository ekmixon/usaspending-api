...
def test_delete_fabs_success():
    ...
    award_ids_left = {award.id for award in awards_left}
    expected_awards_ids_left = {2, 3}
    assert award_ids_left == expected_awards_ids_left

    latest_transaction_ids = {award.latest_transaction_id for award in awards_left}
    ...
    transaction_fabs_left = {
        transaction_fabs.published_award_financial_assistance_id
